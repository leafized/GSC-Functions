 ...
 * Decompiled File: _achievement_engine_z_utils.gsc
 * Game: Call of Duty: WWII
 * Platform: PC
 * Function Count: 30
 * Decompile Time: 1493 ms
...
//Function Number: 6
//send special
ae_sendzombiesspecial_zm(param_00 /*player*/ */,param_01/*challenge*/,param_02/*isGenuine*/,param_03/*unused*/)
{
	//ae_sendzombiesspecial_zm(self ,"player_zombie_collect_fish", true);
	//param_00 -> player
	//param_01 -> challenge
	//param_02 -> bool
	//param_03 -> 
	...
	switch(param_01)
	{
		...
		//var_04[0] = 2;//->this is how the game wants to retrieve the data. 
			//var_04 = type
