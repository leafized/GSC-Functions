 ...
 * Platform: PC
 * Function Count: 37
 * Decompile Time: 1732 ms
 * Timestamp: 8/24/2021 10:25:58 PM
*******************************************************************/
...
func_0FD1()
{
	...
	common_scripts\utility::func_3AB3("");
	common_scripts\utility::func_3AB3("\t/$");
	common_scripts\utility::func_3AB3("\tlevel._art_fog_setup = maps\\createart\\" + level.var_015D + "_fog_hdr::main;");
	common_scripts\utility::func_3AB3("\t$/");
}
