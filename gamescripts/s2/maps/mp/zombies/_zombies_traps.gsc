 ...
 * Decompiled File: _zombies_traps.gsc
 * Game: Call of Duty: WWII
 * Platform: PC
 * Function Count: 88
 * Decompile Time: 4292 ms
 * Timestamp: 8/24/2021 10:25:50 PM
*******************************************************************/
...
func_9CD4()
{
	...
	for(;;)
	{
		...
		else
		{
			...
			if(!var_00 maps/mp/gametypes/zombies::func_11C2(var_02))//if(!player maps\mp\gametypes\zombies::hasEnoughMoney( self.var_267B ) )
			{
