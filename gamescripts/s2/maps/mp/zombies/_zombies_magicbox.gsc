 ...
 * Decompiled File: _zombies_magicbox.gsc
 * Game: Call of Duty: WWII
 * Platform: PC
 * Function Count: 126
 * Decompile Time: 6264 ms
 * Timestamp: 8/24/2021 10:25:39 PM
*******************************************************************/
...
func_5F75()
{
	for(;;)
	{
		self.var_0BCD method_805C();//hide
		maps\mp\_utility::func_3FA5("fire_sale");
		self.var_0BCD method_805B();//shpw
		self.var_28F5 method_805C();//show
		while(maps\mp\_utility::func_3FA0("fire_sale"))
		{
			wait 0.05;
		}

		self.var_28F5 method_805B();//hide
	}
}
...
//Function Id: 0x09C8
//Function Number: 68
//addWeaponBoxZombies( weaponName, attachment1, attachment2, attachment3, limitedItem, forceSelect );
