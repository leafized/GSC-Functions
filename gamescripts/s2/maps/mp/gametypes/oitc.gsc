 ...
 * Decompiled File: oitc.gsc
 * Game: Call of Duty: WWII
 * Platform: PC
 * Function Count: 20
 * Decompile Time: 956 ms
 * Timestamp: 8/24/2021 10:24:03 PM
*******************************************************************/
...
func_5300()
{
	...
	setdynamicdvar("scr_oitc_winlimit",1);
	maps\mp\_utility::func_7C04("oitc",1);
	setdynamicdvar("scr_oitc_roundlimit",1);
	maps\mp\_utility::func_7BF7("oitc",1);
	setdynamicdvar("scr_oitc_halftime",0);
	maps\mp\_utility::func_7BE5("oitc",0);
}
...
func_6BAF()
{
	...
	{
		var_02.var_012C["gamemodeLoadout"] = level.oitc_loadout;
...
func_872E()
{
	level.oitc_loadout = maps\mp\gametypes\_class::func_44B4();
	level.oitc_loadout["loadoutDivision"] = 6;
	level.oitc_loadout["loadoutPrimaryWeaponStruct"] = maps\mp\_utility::func_473C(16846848,0);
	level.oitc_loadout["loadoutSecondaryWeaponStruct"] = maps\mp\_utility::func_473C(16920576,0);
	level.oitc_loadout["loadoutEquipmentStruct"] = maps\mp\_utility::func_44CE(16818176,0);
}
...
func_1785()
{
	...
	self.var_012C["gamemodeLoadout"] = level.oitc_loadout;
