 ...
 * Decompiled File: _healthoverlay.gsc
 * Game: Call of Duty: WWII
 * Platform: PC
 * Function Count: 11
 * Decompile Time: 513 ms
 * Timestamp: 8/24/2021 10:21:57 PM
*******************************************************************/
...
func_73FC()
{
	...
	var_00 = 0;
	thread func_7434();//playerPainBreathingSound()
	for(;;)
	{
		self waittill("damage",var_01,var_02,var_03,var_04,var_05);
		if(self.var_00BC <= 0)//player dead
		{
			return;
		}
