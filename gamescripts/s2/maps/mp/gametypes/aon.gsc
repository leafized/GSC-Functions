 ...
 * Decompiled File: aon.gsc
 * Game: Call of Duty: WWII
 * Platform: PC
 * Function Count: 20
 * Decompile Time: 1278 ms
 * Timestamp: 8/24/2021 10:23:24 PM
*******************************************************************/
...
func_6BAF()
{
	...
	{
		var_02.var_012C["gamemodeLoadout"] = level.aon_loadout;
...
func_872E()
{
	level.aon_loadout = maps\mp\gametypes\_class::func_44B4();
	level.aon_loadout["loadoutDivision"] = 6;
	level.aon_loadout["loadoutPrimaryWeaponStruct"] = maps\mp\_utility::func_473C(16846848,0);
	level.aon_loadout["loadoutSecondaryWeaponStruct"] = maps\mp\_utility::func_473C(16920576,0);
	level.aon_loadout["loadoutEquipmentStruct"] = maps\mp\_utility::func_44CE(16818176,0);
}
...
func_1785()
{
	...
	self.var_012C["gamemodeLoadout"] = level.aon_loadout;
