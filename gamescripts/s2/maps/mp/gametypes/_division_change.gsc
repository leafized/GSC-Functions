 ...
 * Decompiled File: _division_change.gsc
 * Game: Call of Duty: WWII
 * Platform: PC
 * Function Count: 21
 * Decompile Time: 1067 ms
 * Timestamp: 8/24/2021 10:21:35 PM
*******************************************************************/
...
func_63AC(param_00)
{
	...
	for(;;)
	{
		...
		{
			if(maps\mp\_utility::isdivisionsglobaloverhaulenabled() && self.var_0079 == 6 && isdefined(self.var_012C["resistanceScramblerIndicatorActive"]))
			{
			}
			else
			{
