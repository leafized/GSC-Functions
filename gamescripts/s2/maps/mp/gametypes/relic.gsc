 ...
 * Decompiled File: relic.gsc
 * Game: Call of Duty: WWII
 * Platform: PC
 * Function Count: 104
 * Decompile Time: 5156 ms
 * Timestamp: 8/24/2021 10:24:16 PM
*******************************************************************/
...
func_00F9()
{
	...
	level.var_0611["mp_infected_zombie_vision_01"] = loadfx("vfx/unique/mp_infected_zombie_vision_01");
	level.var_0611["infected_turn_lightning_01"] = loadfx("vfx/unique/infected_turn_lightning_01");
...
awardgoal(param_00,param_01)
{
	...
	level.previoussoulcaptureorigin = param_01.var_0116;
	...
	param_01.var_012C["souls"] = param_01.souls_captured;
	param_01 maps\mp\_utility::func_867C(param_01.var_012C["souls"]);
	...
	level.var_1562[0] func_154E(param_01.var_0116);
	param_01 lib_0468::func_0A22("soulCap");
}
...
func_1455(param_00,param_01)
{
	...
	while(!level.var_3F9D)
	{
		...
		if(isdefined(level.var_1562[0].var_2006) && level.var_1562[0].var_2006 == param_01)
		{
			...
			param_01.var_012C["time"] = param_01.time_holding_relic;
			param_01 maps\mp\_utility::func_867B(param_01.var_012C["time"]);
...
func_7F58()
{
	...
	var_00 = getdvarint("scr_relic_num_balls",1);
	func_1519(var_00);
	level.var_0611["ball_vm"] = loadfx("vfx/unique/mp_relic_vm_01");
	level.var_0611["ball_trail"] = loadfx("vfx/trail/vfx_relic_ball_trl");
	level.var_0611["ball_download"] = loadfx("vfx/trail/vfx_relic_ball_trl2");
...
func_154D()
{
	...
	lib_0378::func_8D74("aud_mp_zombie_relic_teleport",var_00.var_0116);
...
{
	var_02 = level.var_721C.var_01A7;
	var_03 = maps\mp\_utility::func_45DE(level.var_721C.var_01A7);
	foreach(var_05 in level.var_744A)
	{
		if(var_05.var_01A7 == var_02)
		{
...
func_1535(param_00)
{
	...
	param_00 setcostumemodels([492,492,0,0,0],param_00.var_01A7,1,1);
...
func_1509()
{
	...
	var_04 = common_scripts\utility::func_0F92(level.var_1554);
	foreach(var_06 in var_04)
	{
		...
		{
			var_07 = distance2d(level.previoussoulcaptureorigin,var_06.var_0116);
		...
		{
			if(!common_scripts\utility::func_0F79(level.previousrelicusedspawns,var_06.var_0116))
			{
				var_01 = var_06;
			}
		}
...
func_150A(param_00)
{
	...
	level.previousrelicusedspawns[level.previousrelicusedspawns.size] = param_00.var_0116;
}
...
func_1511()
{
	if(isdefined(self.var_2006))
	{
		...
		if(!var_00.var_4B7F)
		{
			var_00 maps\mp\_utility::func_0735("specialty_sprintfire");
		}
		...
		{
			var_03 = maps\mp\gametypes\_class::func_1F93(var_00.var_0079,var_00.var_01A7);
...
func_1519(param_00)
{
	...
	var_0C = level.var_1554[0].var_0116;
	level.var_1554 = [];
	func_1508(var_0C);
	var_0D = var_0C;
	var_0E = [];
	...
	{
		var_11 = 2;
		var_12 = getnodesinradius(var_10.var_0116,2000,700,1200);
		var_12 = common_scripts\utility::func_0F92(var_12);
		var_13 = 0;
		for(var_14 = 0;var_13 < var_11 && var_14 < var_12.size;var_14++)
		{
			var_15 = var_12[var_14].var_0116;
			var_16 = 1;
