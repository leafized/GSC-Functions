 ...
 * Decompiled File: _awards.gsc
 * Game: Call of Duty: WWII
 * Platform: PC
 * Function Count: 18
 * Decompile Time: 841 ms
 * Timestamp: 8/24/2021 10:26:04 PM
*******************************************************************/
...
func_6B6C()
{
	for(;;)
	{
		...
		if(!isdefined(var_00.var_012C["stats"]))
		{
			var_00.var_012C["stats"] = [];
		}

		var_00.var_9337 = var_00.var_012C["stats"];
...
func_46EB(param_00)
{
	var_01 = param_00.var_015C;
	if(!level.var_984D)
	{
		var_01 = param_00.var_008F;
	}
