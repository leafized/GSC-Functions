...
init()
{
	set_function_pointer( "explosion_anim", "dest_mercedesw136b", ::get_explosion_animation );
	set_function_pointer( "flattire_anim", "dest_mercedesw136b", ::get_flattire_animation );

	build_destructible_radiusdamage( "dest_mercedesw136b", undefined, 240, 210, 60, true );
	build_destructible_deathquake( "dest_mercedesw136b", 0.4, 1.0, 500 );

	set_pre_explosion( "dest_mercedesw136b", "destructibles/fx_dest_fire_car_fade_40" );
}
