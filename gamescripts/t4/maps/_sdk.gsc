// _sdk.gsc
// Sets up the behavior for the SDKFZ.
...
{
	build_template( "sdk", model, type );
	build_localinit( ::init_local );
	build_deathmodel( "vehicle_german_armored_car", "vehicle_ger_wheeled_sdk222_d", undefined, do_build_death );
	build_deathmodel( "vehicle_ger_wheeled_sdk222", "vehicle_ger_wheeled_sdk222_d", undefined, do_build_death );
	build_deathmodel( "vehicle_ger_wheeled_sdk222_cammo", "vehicle_ger_wheeled_sdk222_d", undefined, do_build_death );
	build_deathmodel( "vehicle_ger_wheeled_sdk222_winter", "vehicle_ger_wheeled_sdk222_d", undefined, do_build_death );
	...
	build_deathfx( "vehicle/vexplosion/fx_vexplode_ger_sdkfz222", "tag_origin", "explo_metal_rand" );
