...
zombie_think()
{
	...
	else if( ( isDefined(level.DLC3.riserZombiesGoToDoorsFirst) && level.DLC3.riserZombiesGoToDoorsFirst ) && rise_struct_string == "riser_door")
	{
		origin = self.origin;
	...
	else if ( ( (isDefined(level.DLC3.riserZombiesGoToDoorsFirst) && level.DLC3.riserZombiesGoToDoorsFirst) && 
...
zombie_assure_node()
{
	...
	if( isDefined(level.DLC3.assureNodes) && level.DLC3.assureNodes )
	{
		wait(2);
...
do_zombie_rise()
{
	...
	if( ( isDefined(level.DLC3.riserZombiesInActiveZonesOnly) && level.DLC3.riserZombiesInActiveZonesOnly ) && 
