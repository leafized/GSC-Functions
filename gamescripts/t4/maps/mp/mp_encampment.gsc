main()
{
//	maps\mp\mp_encampment_fx::main();
//	maps\mp\createart\mp_encampment_art::main();


	maps\mp\_load::main();
	
//	thread maps\mp\mp_encampment_amb::main();

	// uncomment this when you have your own mini-map for this map
//	maps\mp\_compass::setupMiniMap("compass_map_mp_encampment");
