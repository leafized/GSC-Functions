...
main(model,type)
{
	build_template( "buffalo_player", model, type );
	build_localinit( ::init_local );
	build_deathmodel( "vehicle_ltv4_buffalo", "vehicle_ltv4_buffalo_d" );
	build_deathmodel( "vehicle_usa_tracked_lvt4", "vehicle_usa_tracked_lvt4" );
	build_deathmodel( "vehicle_american_sherman", "vehicle_american_sherman_d" );
