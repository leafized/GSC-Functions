...
main()
{
	codescripts\character::setModelFromArray(xmodelalias\char_rus_guardwet2_bodyalias::main());
	...
	self.gearModel = codescripts\character::randomElement(xmodelalias\char_rus_guardwet2_gearalias::main());
...
precache()
{
	codescripts\character::precacheModelArray(xmodelalias\char_rus_guardwet2_bodyalias::main());
	...
	codescripts\character::precacheModelArray(xmodelalias\char_rus_guardwet2_gearalias::main());
