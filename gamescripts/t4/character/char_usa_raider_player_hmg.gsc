...
main()
{
	self setModel("char_usa_raider_player_body_hmg");
	self.headModel = "char_usa_raider_player_head_hmg";
...
precache()
{
	precacheModel("char_usa_raider_player_body_hmg");
	precacheModel("char_usa_raider_player_head_hmg");
