...
main()
{
	codescripts\character::setModelFromArray(xmodelalias\char_ger_honorgd2_bodyzalias::main());
...
precache()
{
	codescripts\character::precacheModelArray(xmodelalias\char_ger_honorgd2_bodyzalias::main());
