...
main()
{
	self setModel("char_rus_guard_player_body_hmg");
	self.headModel = "char_rus_guard_player_head_hmg";
...
precache()
{
	precacheModel("char_rus_guard_player_body_hmg");
	precacheModel("char_rus_guard_player_head_hmg");
