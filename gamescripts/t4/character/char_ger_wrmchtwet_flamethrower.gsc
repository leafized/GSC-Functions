...
main()
{
	codescripts\character::setModelFromArray(xmodelalias\char_ger_wrmchtwet_bodyalias::main());
	...
	self.gearModel = "char_ger_wermacht_gearf";
...
precache()
{
	codescripts\character::precacheModelArray(xmodelalias\char_ger_wrmchtwet_bodyalias::main());
	...
	precacheModel("char_ger_wermacht_gearf");
