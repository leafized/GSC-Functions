...
{
/#
	if ( GetDvarInt( "anim_debug_dogs" ) == 1 )
	{
		println( text + " " + getTime() );
	}
	else if ( GetDvarInt( "anim_debug_dogs" ) == self GetEntNum() )
	{
		println( text + " " + getTime() );
	}
#/
...
{
	// fix for "none" weapon some guys have, shotguns shouldn't use the
	// rechamber logic either
...
//CODER CHANGE Lucas Seibert 9/27/2007
//Added utility functionality for identifying gas weapons
usingGasWeapon()
{
	return ( weaponIsGasWeapon( self.weapon ) );
}

usingTopLoadingWeapon()
{
	...
	return ( WeaponClipType( self.weapon ) == 1 );
}
...
usingSMG()
{
	if ( self.primaryweapon == "ppsh" )
		return true;
	if ( self.primaryweapon == "thompson" )
		return true;
	if ( self.primaryweapon == "mp40" )
		return true;
	if ( self.primaryweapon == "type99_lmg" )
		return true;
	if ( self.primaryweapon == "type100_smg" )
		return true;
	if ( self.primaryweapon == "stg44" )
		return true;
	if ( self.primaryweapon == "bar" )
		return true;
	if ( self.primaryweapon == "dp28" )
		return true;
