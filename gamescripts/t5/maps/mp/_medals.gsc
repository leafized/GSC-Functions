...
isWagerMatch = ( getDvarInt( #"xblive_wagermatch" ) != 0 );
if( isWagerMatch )
{
...
{
if ( victim maps\mp\gametypes\_hardpoints::isOneAwayFromKillstreak() )
{
...
{
self maps\mp\gametypes\_persistence::statAdd( "MEDAL_SHARE_PACKAGE", 1, false );
}
}
}
}
...
if ( maps\mp\_challenges::canProcessChallenges() )
{
self thread maps\mp\gametypes\_persistence::statAdd( medalName, 1, false, weapon );
}
}
