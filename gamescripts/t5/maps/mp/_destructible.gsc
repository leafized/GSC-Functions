...
self setClientFlag( level.const_flag_destructable_destroyed );
}
...
{
self SetClientFlag( level.const_flag_destructible_car );
...
self ClearClientFlag( level.const_flag_destructible_car );
}
